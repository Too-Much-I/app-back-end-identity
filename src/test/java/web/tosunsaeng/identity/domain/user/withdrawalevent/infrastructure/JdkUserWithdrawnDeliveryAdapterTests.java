...
class JdkUserWithdrawnDeliveryAdapterTests {
	private static final Instant NOW = Instant.parse("2026-09-03T00:00:00Z");

	@Test
	@SuppressWarnings("unchecked")
	void withdrawalDeliveryKeepsTheWithdrawnPurpose() throws Exception {
		...
		JdkUserWithdrawnDeliveryAdapter adapter = new JdkUserWithdrawnDeliveryAdapter(
				URI.create("https://learning.internal/internal/v1/events/withdrawn"),
		...
		assertThat(adapter.deliver("{}".getBytes(java.nio.charset.StandardCharsets.UTF_8)))
				.isEqualTo(204);
		assertThat(purpose.get()).isEqualTo(WorkloadIdentityPurpose.USER_WITHDRAWN);
	}
}
