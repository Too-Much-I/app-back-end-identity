...
@Schema(description = "Firebase 신규 MEMBER 가입 완료 요청")
public record FirebaseSignupRequest(
		@Schema(description = "로그인 교환에서 발급된 enrollment UUID")
	...
	public String toString() {
		return "FirebaseSignupRequest[enrollmentId=[REDACTED], firebaseIdToken=[REDACTED], "
				+ "nickname=[REDACTED], consents=[REDACTED]]";
	}
}
