...
import web.tosunsaeng.identity.domain.auth.application.phone.PhoneIdentityTransactionService;
import web.tosunsaeng.identity.domain.auth.domain.phone.PhoneFingerprintHasher;
import web.tosunsaeng.identity.domain.auth.domain.phone.PhoneFingerprintKeyRegistry;
import web.tosunsaeng.identity.domain.auth.domain.phone.PhoneNumberNormalizer;
